...
enum CafAuditSwaggerUiBundle implements ConfiguredBundle<Object>
{
    INSTANCE;
    ...
    private static final String SWAGGER_UI_BASE_PATH = "/caf-audit-service-ui";
    ...
    public void initialize(final Bootstrap<?> bootstrap)
    {
        ...
        bootstrap.addBundle(new AssetsBundle(
                "/com/github/cafaudit/service/contract/swagger.yaml",
