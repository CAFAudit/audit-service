...
/**
 * Integration test for AuditMonkey, running the testing framework.
 */
public class AuditMonkeyAcceptanceIT extends UseAsTestName_TestBase
{
    ...
    {
        testControllerProvider = new AuditMonkeyTestControllerProvider();
